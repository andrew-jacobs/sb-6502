...
;                                      
; An Extended 65C02 eForth for the SB-6502
;-------------------------------------------------------------------------------
...
; Notes:
;
; This is an implementation of C.H Ting's eForth model for the WDC 65C02
...
;
; To make the standard model more efficient on the 65C02 I have made a few
...
RESET:
		...
		stz	TXHEAD		; Empty the UART buffers
		stz	TXTAIL
		stz	RXHEAD
		stz	RXTAIL		
